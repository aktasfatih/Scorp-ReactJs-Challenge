    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmission}>
                Email: <br />{login.email ? login.email : "-"}<br/>
                Username: <br />{login.username ? login.username : "-"}<br />
                Phone:<br /><input onChange={e => setphone(e.target.value)} type="tel" id="phone" name="phone" placeholder="123-45-678" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" required /><br />
                <textarea onChange={e => settext(e.target.value)} id="w3review" name="w3review" rows="4" cols="50"></textarea>
                <Autocomplete
                    id="combo-box-demo"
                    options={countryList}
